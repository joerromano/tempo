...
public class SQLDatasourceUnitTest {
  ...
  public void addGroupTest() {
    Date now = new Date();
    Coach c = new Coach("test_coach_id", "coach_gmail", "mitchell_baker",
        new PostalCode("10012"));
    Team t = new Team("test_team", "team_name", new PostalCode("02912"), c,
        true);
  ...
  public void addGroupWithBadTeamTest() {
    ...
    Coach c = new Coach("test_coach_id", "coach_gmail", "mitchell_baker",
        new PostalCode("10012"));
    Team t = new Team("not_a_team", "team_name", new PostalCode("12345"), c,
        false);
  ...
  public void renameGroupTest() {
    ...
    Group renamedGroup = datasource.renameGroup(returnedGroup,
        "renamed_group_name");
...
//  }
   ...
   * addWorkoutBadGroupTest() { Date now = new Date(); String rando_id = new
   * BigInteger(80, random).toString(32); Group badGroup = new
   * Group("bad_group", now, "bad_group_id"); Workout toAdd = new
   * Workout("testWK" + rando_id, now, 1, new PostalCode("10012"), "recovery",
   * 1.8, "PM"); Group returned = datasource.addWorkout(badGroup, toAdd); }
   */
  ...
  public void getGroupsTest() throws ParseException {
    ...
    Team t = new Team("test_team", "team_name", new PostalCode("02912"), c,
        true);
    Collection<Group> retrievedGroups = datasource.getGroups(t, earlierDate,
        now);
  ...
  public void addMemberTest() {
    String randomEmail = "jj_" + new BigInteger(80, random).toString(32)
        + "@gmail.com";
    Coach c = new Coach("test_coach_id", "coach_gmail", "mitchell_baker",
        new PostalCode("10012"));
    Team t = new Team("test_team", "team_name", new PostalCode("02912"), c,
        true);
    Athlete addedAthlete = datasource.addMember(t, randomEmail, "1231231234",
        "Simon Belete", new PostalCode("10013"));
  ...
  public void addMemberNoTeamTest() {
    Coach c = new Coach("test_coach_id", "coach_gmail", "mitchell_baker",
        new PostalCode("10012"));
    Team t = new Team("not_a_team", "team_name", new PostalCode("02912"), c,
        true);
    datasource.addMember(t, "not_an_email_yay", "1231231234", "Simon Belete",
        new PostalCode("10013"));
  }
  ...
  public void updateMembersTest2() {
    String randomEmail1 = "jj1_" + new BigInteger(80, random).toString(32)
        + "@gmail.com";
    String randomEmail2 = "pj2_" + new BigInteger(80, random).toString(32)
        + "@gmail.com";
    ...
    Athlete addedAthlete1 = datasource.addMember(t, randomEmail1, "1002003333",
        "JJ", new PostalCode("10013"));
    Athlete addedAthlete2 = datasource.addMember(t, randomEmail2, "1002004444",
        "PJ", new PostalCode("10012"));
  ...
  /*
   * // @Test public void updateWorkoutTest() { Date now = new Date(); String
   * rando_id = new BigInteger(80, random).toString(32); Group g = new
   * Group("test_name", now, "test_id"); Workout toAdd = new Workout("testWKu" +
   * rando_id, now, 1, new PostalCode("10012"), "recovery", 1.8, "PM"); Group
   * receivedGroup = datasource.addWorkout(g, toAdd); Workout toUpdate = new
   * Workout("testWKu" + rando_id, now, 5, new PostalCode("10013"),
   * "progressive", 1.9, "AM"); Workout updatedWkout =
   * datasource.updateWorkout("testWku" + rando_id, toUpdate); }
   */

  @Test
  public void addTeamTest() {
    String rando_id = new BigInteger(80, random).toString(32);
    Team toAdd = new Team("test_team_id1_" + rando_id, "test_team_name1",
        new PostalCode("11201"), false);
  ...
  public void disbandTeamTest() {
    Team toAdd = new Team("to_be_deleted", "test_team_name1",
        new PostalCode("11201"), false);
    datasource.addTeam(toAdd);
  ...
  public void addCoachTest() {
    String randoEmail = "coach_email" + new BigInteger(80, random).toString(32)
        + "me.org";
    Coach addedCoach = datasource.addCoach("tim springfield", randoEmail,
        new PostalCode("11201"), "pwd1");
    ...
    assertEquals(addedCoach.getLocation().getPostalCode(),
        getCoach.getLocation().getPostalCode());
  }

  @Test(expected = IllegalArgumentException.class)
  public void addDuplicateCoachTest() {
    datasource.addCoach("tim springfield", "coach_gmail@me.org",
        new PostalCode("11201"), "pwd1");
  }

  @Test(expected = IllegalArgumentException.class)
  public void deleteCoachTest() {
    String randoEmail = "coach_email@"
        + new BigInteger(80, random).toString(32);
    Coach addedCoach = datasource.addCoach("tim springfield", randoEmail,
        new PostalCode("11201"), "pwd1");
  ...
  public void updatePasswordTest() {
    String randoEmail = "coach_email" + new BigInteger(80, random).toString(32)
        + "@gmail.com";
    Coach addedCoach = datasource.addCoach("kurt benninger", randoEmail,
        new PostalCode("11202"), "pwd2");

    boolean updated = datasource.updatePassword(addedCoach, "pwd2",
        "much_better_pwd");
    assertTrue(updated);
    Coach authenticatedCoach = datasource.authenticate(randoEmail,
        "much_better_pwd");

    assertEquals(authenticatedCoach.getEmail(), randoEmail);
    assertEquals(authenticatedCoach.getId(), addedCoach.getId());
    assertEquals(authenticatedCoach.getLocation().getPostalCode(),
        addedCoach.getLocation().getPostalCode());
  }
  ...
  public void updateNameTest() {
    String randoEmail = "coach_email_" + new BigInteger(80, random).toString(32)
        + "@verizon.net";
    Coach addedCoach = datasource.addCoach("coach sami", randoEmail,
        new PostalCode("11937"), "pwd_awesome");
  ...
  public void addTeamTestFromCoach() {
    String randoEmail = "coach_email_" + new BigInteger(80, random).toString(32)
        + "@gmail.com";
    Coach addedCoach = datasource.addCoach("simon belete", randoEmail,
        new PostalCode("45902"), "pwd_amazing");

    Team addedTeam = datasource.addTeam(addedCoach, "bwxc");
    assertEquals(addedTeam.getLocation().getPostalCode(),
        addedCoach.getLocation().getPostalCode());
  ...
  public void editAthleteTest() {
    String email = "tom_" + new BigInteger(80, random).toString(32)
        + "@gmail.com";
    Coach c = new Coach("test_coach_id", "coach_gmail", "mitchell_baker",
        new PostalCode("10012"));
    Team t = new Team("test_team", "team_name", new PostalCode("10012"), c,
        true);
    Athlete added = datasource.addMember(t, email, "1234561894", "tom hale",
        new PostalCode("39914"));

    Athlete edited = datasource.editAthlete(added.getId(), "Tom Hale",
        "1234561894", email, new PostalCode("39914"));
  ...
  public void deleteAthleteTest() {
    Coach c = new Coach("test_coach_id", "coach_gmail@gmail.com",
        "mitchell_baker", new PostalCode("10012"));
    Team t = new Team("test_team", "team_name", new PostalCode("10012"), c,
        true);
    Athlete added = datasource.addMember(t, "ath_email1@bing.com", "1234567890",
        "joe", new PostalCode("10012"));
