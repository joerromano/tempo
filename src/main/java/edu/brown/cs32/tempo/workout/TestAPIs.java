...
public class TestAPIs {
	...
	long startTime = System.nanoTime();
       ...
       CurrentWeather cwd = owm.currentWeatherByCoordinates(
        ...
        System.out.println("Weather:" + owm.dailyForecastByCoordinates((float) results[0].geometry.location.lat,
    		   (float) results[0].geometry.location.lng, Byte.parseByte("7")).getMessage());
